...
public class BlockDirtchest extends BlockContainer
{
    ...
    {
        this.checkForSurroundingDirtchests(worldIn, pos, state);
        ...
        while (iterator.hasNext())
        {
            ...
            {
                this.checkForSurroundingDirtchests(worldIn, blockpos1, iblockstate1);
            }
        }
    }
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            {
                ((TileEntityChestDC)tileentity).setCustomName(stack.getDisplayName());
            }
        }
    }

    public IBlockState checkForSurroundingDirtchests(World worldIn, BlockPos p_176455_2_, IBlockState p_176455_3_)
    {
        if (worldIn.isRemote)
        {
            return p_176455_3_;
    ...
    public boolean canPlaceBlockAt(World worldIn, BlockPos pos)
    {
        ...
        {
            if (this.isSurroundingBlockDirtchest(worldIn, blockpos1))
            {
                return false;
            }
        ...
        {
            if (this.isSurroundingBlockDirtchest(worldIn, blockpos2))
            {
                return false;
            }
        ...
        {
            if (this.isSurroundingBlockDirtchest(worldIn, blockpos3))
            {
                return false;
            }
        ...
        {
            if (this.isSurroundingBlockDirtchest(worldIn, blockpos4))
            {
                return false;
            }
    ...
    private boolean isSurroundingBlockDirtchest(World worldIn, BlockPos p_176454_2_)
    {
    ...
    public ILockableContainer getLockableContainer(World worldIn, BlockPos p_180676_2_)
    {
        ...
        {
            Object object = (TileEntityChestDC)tileentity;

            if (this.cannotOpenDirtchest(worldIn, p_180676_2_))
            {
                return null;
            }
            else
            {
                ...
                while (iterator.hasNext())
                {
                    ...
                    if (block == this)
                    {
                        if (this.cannotOpenDirtchest(worldIn, blockpos1))
                        {
                            return null;
                        }
                        ...
                        if (tileentity1 instanceof TileEntityChestDC)
                        {
                            if (enumfacing != EnumFacing.WEST && enumfacing != EnumFacing.NORTH)
                            {
                                object = new InventoryLargeChest("Large Dirtchest", (ILockableContainer)object, (TileEntityChestDC)tileentity1);
                            }
                            else
                            {
                                object = new InventoryLargeChest("Large Dirtchest", (TileEntityChestDC)tileentity1, (ILockableContainer)object);
                            }
                        }
                    }
                }
    ...
    {
        return new TileEntityChestDC();
    }

    public boolean canProvidePower()
    {
        return this.dchestType == 1;
    }
    ...
    public int isProvidingWeakPower(IBlockAccess worldIn, BlockPos pos, IBlockState state, EnumFacing side)
    {
        ...
        else
        {
            ...
            if (tileentity instanceof TileEntityChestDC)
            {
                i = ((TileEntityChestDC)tileentity).numPlayersUsing;
            }
    ...
    private boolean cannotOpenDirtchest(World worldIn, BlockPos p_176457_2_)
    {
    ...
    {
        return worldIn.isSideSolid(p_176456_2_.offsetUp(), EnumFacing.DOWN, false);
    }

    private boolean isOcelotSittingOnChest(World worldIn, BlockPos p_176453_2_)
    {
        Iterator iterator = worldIn.getEntitiesWithinAABB(EntityOcelot.class, new AxisAlignedBB((double)p_176453_2_.getX(), (double)(p_176453_2_.getY() + 1), (double)p_176453_2_.getZ(), (double)(p_176453_2_.getX() + 1), (double)(p_176453_2_.getY() + 2), (double)(p_176453_2_.getZ() + 1))).iterator();
