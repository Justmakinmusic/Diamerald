	...
	private static boolean keepInventory;
	   ...
	   /* @SideOnly(Side.CLIENT)
	    ...
	    public boolean onBlockActivated(World par1World, int xCoord, int yCoord, int zCoord, EntityPlayer par5Player, int par6, float par7, float par8, float par9)
	    {
	        ...
	        {
	            TileEntityDfurnace tileentitydfurnace = (TileEntityDfurnace)par1World.getTileEntity(new BlockPos(xCoord, yCoord, zCoord));
	   ...
	   /*public static void updateDfurnaceBlockState(boolean par0, World par2World, int xCoord, int yCoord, int zCoord)
	    ...
	    public static void updateDfurnaceBlockState(boolean par0, World par2World, BlockPos pos)/*(int xCoord, int yCoord, int zCoord)*/
	    {
		   IBlockState iblockstate = par2World.getBlockState(pos);
	        ...
	        if (par0)
	        {
	            //par2World.setBlock(pos, Diamerald.Dfurnace_on);
