...
public class Diameraldhoe extends ItemHoe {
	...
	public boolean onItemUse(ItemStack par1ItemStack,
		...
		if (!par2EntityPlayer.canPlayerEdit(par4, par5, par6, par7,
			...
			for (int i = -2; i < 3; i++) {
				for (int j = -2; j < 3; j++) {
					Block block = par3World.func_147439_a(par4 + j, par5, par6
							+ i);
//					Block block1 = par3World.func_147439_a(par4 + j, par5 + 1,
//							par6 + i);

					if (!((par7 == 0
							|| par3World.func_147439_a(par4 + j, par5 + 1, par6 + i).isAir(par3World, par4 + j, par5 + 1, par6
						...
						par3World.playSoundEffect(
										...
										block2.field_149762_H.func_150498_e(),
										(block2.field_149762_H.func_150497_c() + 1.0F) / 2.0F,
										block2.field_149762_H.func_150494_d() * 0.8F);
						if (!par3World.isRemote) {
							par3World.func_147449_b(par4 + j, par5, par6 + i,
									Blocks.farmland);
						}
					}
				}
